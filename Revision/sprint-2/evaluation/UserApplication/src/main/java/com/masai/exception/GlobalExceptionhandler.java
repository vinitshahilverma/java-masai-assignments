...
public class GlobalExceptionhandler {
	...
	@ExceptionHandler(UserException.class)
	   public ResponseEntity<MyErrorDetails> userExceptionHandler(UserException be,WebRequest req){
	...
	@ExceptionHandler(EmailException.class)
	   public ResponseEntity<MyErrorDetails> emailExceptionHandler(EmailException be,WebRequest req){
